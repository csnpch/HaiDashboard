...
import { IIncidentsDrillDown } from "@/interfaces/api/hospital"
...
export default function Incedetns(props: propsInterface) {
    ...
    const [hospitals, setHospitals] = useState<IIncidentsDrillDown[]>([])
    ...
    const fetchData = async () => {
        try {
            const res = await XverServices.HospitalsWithIncidents(
            ...
            const sortedIncident = res.data.sort((a: IIncidentsDrillDown, b: IIncidentsDrillDown) => {
                b.incident_rate - a.incident_rate
            })
            setHospitals(sortedIncident)
        } catch (err: any) {
            console.log(err)
            setLoading(prevState => ({
                ...prevState,
